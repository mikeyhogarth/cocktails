...
export const ROBOT_CONNECTED = "ROBOT_CONNECTED";
export const ROBOT_DISCONNECTED = "ROBOT_DISCONNECTED";
export const ROBOT_STATE_CHANGED = "ROBOT_STATE_CHANGED";
export const ROBOT_CONFIG_LOADED = "ROBOT_CONFIG_LOADED";
export const ROBOT_JOB_UPDATED = "ROBOT_JOB_UPDATED";
export const ROBOT_BAR_SYNCED = "ROBOT_BAR_SYNCED";
